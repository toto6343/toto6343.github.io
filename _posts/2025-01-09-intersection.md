...
featured-img: _img/intersection.jpg
...
프로젝트 수행 과정에서는 데이터 수집, 전처리, 모델 학습, 분석까지 전 과정을 경험했습니다.
...
3️⃣ **모델 학습 및 튜닝**  
- YOLO 모델 사용  
- 학습 결과, 신뢰도(Confidence) 기반 예측 성능 평가
...
실시간 처리 속도와 정확도 균형을 고려해서 모델 구조를 선택했습니다.
